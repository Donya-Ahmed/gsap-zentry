           ...
           <div className="flex flex-col gap-8">
            <div className="cursor-pointer ">
             <TiltCard>
              ...
              <div className="flex gap-4 mt-4"><p className="font-general text-[10px]">09.05.2024</p><p className="w-64 font-circular-web font-[600] ms-8">Nexus: Zentry’s Metagame Portal Bridging Human & AI in the Global Play Economy</p></div>
            </div>
              <div className="cursor-pointer ">
             <TiltCard>
                <img
              ...
              <div className="flex gap-4 mt-4"><p className="font-general text-[10px]">22.11.2024</p><p className="w-64 font-circular-web font-[600] ms-8">Zentry Whitepaper: The Blueprint to the Metagame</p></div>
            </div>
           </div>
